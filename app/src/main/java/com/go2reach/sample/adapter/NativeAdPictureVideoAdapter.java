...
public class NativeAdPictureVideoAdapter extends BaseAdapter {
	List<Item> items;
	LayoutInflater inflater;
	public NativeAdPictureVideoAdapter(Context context, List<Item> items){
		this.items = items;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (itemView == null){
			if (item.getType() == Item.TYPE_PRODUCT){
				...
				itemView = inflater.inflate(R.layout.list_item_ad_pic_video, parent, false);
			}
		}
		if (item.getType() == Item.TYPE_PRODUCT){
